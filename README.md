...
[![Portfolio](https://img.shields.io/badge/BillSmart-Live%20Demo-58A6FF?style=for-the-badge&logo=streamlit&logoColor=white)](https://billsmart-8aqppmtesqkrqcxfk5mpyn.streamlit.app/)
...
[![Profile Views](https://komarev.com/ghpvc/?username=kir-an-n&style=for-the-badge&color=58A6FF&label=PROFILE+VIEWS)](https://github.com/kir-an-n)
...
![EasyOCR](https://img.shields.io/badge/EasyOCR-FF6B6B?style=for-the-badge&logo=python&logoColor=white)
...
| Feature | Details |
|--------|---------|
| 📸 **Receipt Scanning** | EasyOCR extracts line items and totals from any receipt photo |
| 🏷️ **Smart Categorization** | Auto-tags expenses (Food, Transport, Utilities, etc.) |
| 📊 **Live Dashboard** | Streamlit-powered real-time spending analytics |
| 🇮🇳 **Built for India** | Handles Indian receipt formats, UPI references, and regional text |

**Stack:** Python · EasyOCR · Pandas · Streamlit · SQLite

[![Live Demo →](https://img.shields.io/badge/Try%20BillSmart%20Live-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white)](https://billsmart-8aqppmtesqkrqcxfk5mpyn.streamlit.app/)
...
![Profile Views](https://komarev.com/ghpvc/?username=kir-an-n&style=for-the-badge&color=58A6FF&label=TOTAL+PROFILE+VIEWS)
...
*"Lemme be wrong, lemme fail, lemme learn, lemme correct, lemme take the chance, lemme do ."*
